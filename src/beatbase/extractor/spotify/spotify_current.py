...
from beatbase.shared.config import SPOTIFY_CACHE_PATH
...
def get_current_spotify_track() -> dict | None:
    ...
    # WHY: Cache liegt im zentralen data/-Ordner (shared/config.py), unabhaengig
    # vom Modul-Pfad. So ueberlebt der OAuth-Token Modul-Umzuege.
