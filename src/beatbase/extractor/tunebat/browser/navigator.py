...
from beatbase.extractor.tunebat.config import MATCH_THRESHOLD
from beatbase.extractor.tunebat.db import save_search_results
from beatbase.extractor.tunebat.scraper.results_parser import parse_search_results
from beatbase.shared.config import SAVE_TUNEBAT_HTML, TUNEBAT_SEARCHES_HTML_DIR, TUNEBAT_URL
...
def _save_debug_html(target_string: str, html_content: str):
    ...
    try:
        TUNEBAT_SEARCHES_HTML_DIR.mkdir(parents=True, exist_ok=True)
        ...
        file_path = TUNEBAT_SEARCHES_HTML_DIR / f"{safe_name}.html"
